...
# mesh
def mesh2pcl_color(triangle_collection, triangle_color_collection, numpoints):
    area_collection = calc_area(triangle_collection)
    total_area = np.sum(area_collection)
    ...
    sampled_points =  rand_uv[:,[0]] * (sampled_triangle_collection[:,1,:3] - sampled_triangle_collection[:,0,:3]) \
